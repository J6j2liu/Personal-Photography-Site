    ...
    <div className="h-full overflow-auto text-center pt-[110px] bg-stone-900">
      <main>
        <div className="flex flex-col h-full items-center">
          ...
          <div className="flex relative max-w-[900px] justify-center justify-between gap-5 cursor-pointer">
            <Link href="https://github.com/J6j2liu/website" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 496 512"
      ...
      <footer className="relative h-[90px] flex justify-center align-center uppercase text-lg font-medium z-20 select-none my-10">
